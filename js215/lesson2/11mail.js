...
function mailCount(emailData) {
  ...
  let dates = messages.map(email => {
    let dateParts = email.split('#/#')[2] // gets the Date section (e.g. '\nDate: 07-27-2016')
                       .split(' ')[1]     // gets only the date string (e.g., MM-DD-YYYY format)
                       .split('-');       // separates date string into parts
