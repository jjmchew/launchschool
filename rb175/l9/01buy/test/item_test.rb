...
class ItemTest < Minitest::Test
  ...
  def test_new_item_no_dates
    ...
    assert_equal "", sauce.list
  end

  def test_new_item_not_obj
    assert_raises(ArgumentError) {
      Item.new("pasta sauce", "2023-7-14")
    }
  end
  ...
  def test_new_item_no_qty_ok
    ...
    assert_equal '2023-03-12, 2024-05-12, 2025-11-17', sauce.list
  end
  ...
  def test_add_item_no_qty_ok
    ...
    assert_equal '2023-03-12, 2024-05-12, 2024-07-01, 2025-11-17', sauce.list
  end
  ...
  def test_add_item_no_qty_ok
    ...
    assert_equal '2023-04-01 x12, 2023-06-01 x6, 2023-12-23 x6', bagels.list
  end
  ...
  def test_use_item_no_date_qty_1
    ...
    assert_equal '2024-05-12, 2025-11-17', sauce.list
  end
  ...
  def test_use_item_no_date_qty_more_than
    ...
    assert_equal '2023-12-23 x5', bagels.list
  end
  ...
  def test_use_item_no_date_qty_less_than
    ...
    assert_equal '2023-06-01 x3, 2023-12-23 x6', bagels.list
  end
end
