...
# the error happens since 'send' is a standard method on BasicObject in which the symbol following the opening bracket is interpreted as a method, hence the error.
# can fix the error by include the Mailing module which will overwrite the method `send` included in BasicObject