...
output
  - true or false
rules
  - if array1 is nil OR array2 is nil - return false
  - each of the elements in array2 should be equal to an element from array1 squared, each element must be accounted for

algorithm
  - address nil inputs :  return false if array1 or array2 are nil
  - transform array1
      - square each element
      - sort all of the resulting elements
  - this transformed array1 should be equal to array2 sorted
