...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: jjmchew
--
...
ALTER TABLE public.weather OWNER TO jjmchew;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: jjmchew
--
