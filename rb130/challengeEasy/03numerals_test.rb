...
class RomanNumeralsTest < Minitest::Test
  ...
  def test_24
    # skip
    number = RomanNumeral.new(24)
    assert_equal 'XXIV', number.to_roman
  end
  ...
  def test_369
    number = RomanNumeral.new(369)
    assert_equal 'CCCLXIX', number.to_roman
  end
  ...
  def test_448
    number = RomanNumeral.new(448)
    assert_equal 'CDXLVIII', number.to_roman
  end
  ...
  def test_1998
    # skip
    number = RomanNumeral.new(1998)
    assert_equal 'MCMXCVIII', number.to_roman
  end
