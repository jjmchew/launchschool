...
output
  integer : # of times letters at same position in the 2 strings do NOT match

rules
  - assume only valid letters provided:
      - just check for equality b/w 2 char at the same positions
