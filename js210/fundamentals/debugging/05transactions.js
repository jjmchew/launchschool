...
/*
An error is raised when a non-numeric amount is entered for a transaction.
The error is thrown since there is no error object defined and passed into the `catch` block. Adding a parameter `error` for the `catch` block solves the problem.
*/
