function getSelectedColumns(numbers, cols) {
  ...
  // for (var i = 0, length = numbers.length; i < length; i += 1) { // bad syntax in for loop ** WRONG : bug isn't b/c of bad syntax
  for (var i = 0; i < numbers.length; i += 1) {

    // for (var j = 0, length = cols.length; j < length; j += 1) {  // bad syntax in for loop ** WRONG: bug is not from syntax
